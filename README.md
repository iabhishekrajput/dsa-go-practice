...
|---|-------|----------|--------------|
| 00 | [Practice](00-practice/) | 4 | Slow/fast pointer, running min/max, heap + linked list merge |
...
| 04 | [Linked Lists](04-linkedlists/) | 3 | Pointer reversal, Floyd's cycle detection, dummy node merge |
| 05 | [Stacks](05-stacks/) | 7 | Bracket matching, monotonic stack, min tracking, RPN evaluation, collision simulation |
| 06 | [Queues](06-queues/) | 4 | Two-stack queue, monotonic deque, circular buffer (ring buffer) |
| 07 | [Recursion](07-recursion/) | 3 | Fast exponentiation, recursive reversal, divide-and-conquer (merge sort) |
...
**47 problems solved** across 10 topics.

## Project Structure

```
dsa/
├── 00-practice/             # Cross-topic practice problems
├── 01-arrays/
│   ├── two_sum.go
│   ├── two_sum_test.go
...
# Run a single test
go test ./05-stacks/ -v -run TestEvalRPN
```
